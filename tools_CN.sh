...
menu() {
	...
	case ${selectInstallType} in
		1)
			...
			;;
		2)
			bash <(curl -s https://ghproxy.com/https://raw.githubusercontent.com/profei/myws/master/bbr.sh)
			;;
		3)
		...
		12)
			...
			;;
		13)
			bash <(curl -s https://ghproxy.com/https://raw.githubusercontent.com/profei/myws/master/golang)			
			;;
		14)
